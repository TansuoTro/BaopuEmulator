...
export function buildRecommendPrompt(
  ...
  return JSON.stringify({
    ...
    instruction: '综合所有数据（画像、高考、毕业意向、开放回答、情景回答），严格遵循SYSTEM_PROMPT中的"毕业意向×专业"推荐规则。输出：(1)personality_sketch—3~5句人物侧写；(2)top_majors—Top5按score降序，每专业给match_reason(结合高考数据和毕业意向)、risk、suitable_for、not_suitable_for；(3)final_note—一句话，必须呼应毕业意向。output_format:{"type":"recommend","personality_sketch":"...","summary":{"confidence":...},"top_majors":[...],"final_note":"..."}',
  });
}
